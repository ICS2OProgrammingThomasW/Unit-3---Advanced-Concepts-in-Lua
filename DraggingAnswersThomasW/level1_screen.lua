...
local function TouchListenerAnswerBox3(touch)
    ...
    if (answerboxAlreadyTouched == false) and 
        ...
        elseif (touch.phase == "ended") then
            ...
            -- if the box is in the userAnswerBox Placeholder  go to center of placeholder
            if (((userAnswerBoxPlaceholder.x - userAnswerBoxPlaceholder.width/2) < alternateAnswerBox23x ) and 
                ((userAnswerBoxPlaceholder.x + userAnswerBoxPlaceholder.width/2) > alternateAnswerBox23x ) and 
